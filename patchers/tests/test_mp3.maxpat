...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 97.0, 150.0, 43.0 ],
					"text" : "Adjust this slider and let go for a bit so it can pick up the new bpm"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 232.0, 436.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 411.0, 436.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 233.0, 193.0, 50.0, 21.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 233.0, 97.0, 20.0, 85.0 ],
					"size" : 1.0,
					"varname" : "slider"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 233.0, 223.0, 53.0, 21.0 ],
					"text" : "xbpm $1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 210.0, 204.0, 22.0 ],
									"text" : "combine input ../../examples/warpbuf"
								}
...
, 			{
				"box" : 				{
					...
					"depth" : 2,
					"id" : "obj-40",
					"items" : [ "warpbuf_advanced.ck", ",", "warpbuf_basic.ck", ",", "warpbuf_mp3.ck", ",", "warpbuf_no_warp_file.ck", ",", "warpbuf_silent.ck" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"prefix" : "~/Downloads/projects/chuck-max/examples/warpbuf/",
					"types" : ".ck"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 49.0, 644.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "chuck~ : test warpbuf.chug playing mp3 file"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 516.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 238.0, 397.0, 167.0, 21.0 ],
					"text" : "chuck~ 2 test/warpbuf_mp3.ck",
					"varname" : "chuck-0"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 1 ],
					"midpoints" : [ 456.5, 423.5, 358.5, 423.5 ],
					"order" : 1,
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 456.5, 425.5, 241.5, 425.5 ],
					"order" : 2,
					"source" : [ "obj-36", 1 ]
				}

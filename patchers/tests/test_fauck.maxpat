...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 357.5, 200.0, 97.0, 21.0 ],
					"text" : "run basic/echo.ck"
				}

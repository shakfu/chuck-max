...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.5, 222.0, 68.0, 21.0 ],
					"text" : "freq_low $1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 210.0, 190.0, 22.0 ],
									"text" : "combine input ../../examples/fauck"
								}
...
, 			{
				"box" : 				{
					...
					"prefix" : "~/Downloads/projects/chuck-max/examples/fauck/",
					"types" : ".ck"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.0, 222.0, 73.0, 21.0 ],
					"text" : "freq_high $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 253.0, 192.0, 50.0, 21.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.0, 96.0, 20.0, 85.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 49.0, 644.0, 31.0 ],
					"text" : "NOTE: the faust chugin requires at least stereo channels to play the examples correctly, since many examples assume stereo channels."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "chuck~ : test fauck.chug (faust chugin)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 516.0, 45.0, 45.0 ]
				}

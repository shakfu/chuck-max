...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 139.0, 456.0, 150.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 226.0, 88.5, 71.0, 104.0 ],
					"text" : "This slider changes a variable in the code on the right. Increase it above 0 and run."
				}
